    ...
    with torch.no_grad():
        ...
        for (imfile1, imfile2) in tqdm(list(zip(left_images, right_images))):
            ...
            if args.mast3r_init:
                ...
                np.save("output/" + args.obj + ".npy", disp[0][0])
            # --
            ...
            # --
            if args.mast3r_init:
                file_stem = file_stem + "_mast3r"
            filename = os.path.join(output_directory, "final_disparity", f"{file_stem}.png")
            # --
            # filename = os.path.join(output_directory, f"{file_stem}.png") # original
...
if __name__ == "__main__":
    ...
    # --
    parser.add_argument("--data_root_dir", help="root directory containing rgb_pairs/ disparity_npy/ folders", default="")
    parser.add_argument('--obj', help="object_name", default="")
    parser.add_argument("--mast3r_init", type=bool, help="Whether or not we use mast3r disparity to initialize SelectiveIGEV")
    # --
